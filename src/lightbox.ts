...
function renderLightbox() {
    ...
    if (isVideo) {
        content.innerHTML = `<video src="${url}" class="max-w-full max-h-full object-contain rounded-lg shadow-2xl" controls autoplay onerror="this.onerror=null; if(this.parentElement) this.parentElement.innerHTML='<div class=\\'flex flex-col items-center justify-center text-white\\'><svg class=\\'w-16 h-16 mb-4 text-red-500\\' fill=\\'none\\' stroke=\\'currentColor\\' viewBox=\\'0 0 24 24\\'><path stroke-linecap=\\'round\\' stroke-linejoin=\\'round\\' stroke-width=\\'2\\' d=\\'M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z\\'></path></svg><span class=\\'text-xl font-medium\\'>Файл поврежден</span></div>';"></video>`;
    } else {
        content.innerHTML = `<img src="${url}" class="max-w-full max-h-full object-contain rounded-lg shadow-2xl" onerror="this.onerror=null; if(this.parentElement) this.parentElement.innerHTML='<div class=\\'flex flex-col items-center justify-center text-white\\'><svg class=\\'w-16 h-16 mb-4 text-red-500\\' fill=\\'none\\' stroke=\\'currentColor\\' viewBox=\\'0 0 24 24\\'><path stroke-linecap=\\'round\\' stroke-linejoin=\\'round\\' stroke-width=\\'2\\' d=\\'M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z\\'></path></svg><span class=\\'text-xl font-medium\\'>Файл поврежден</span></div>';">`;
    }
